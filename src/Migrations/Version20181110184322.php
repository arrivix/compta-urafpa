 ...
 */
final class Version20181110184322 extends AbstractMigration
{
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE ligne_budget DROP id_annee_id');
    }
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE ligne_budget ADD id_annee_id INT NOT NULL');
