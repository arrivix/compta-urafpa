 ...
 */
final class Version20181111102944 extends AbstractMigration
{
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE annee (id INT AUTO_INCREMENT NOT NULL, nom VARCHAR(30) NOT NULL COLLATE utf8mb4_unicode_ci, defaut TINYINT(1) NOT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8 COLLATE utf8_unicode_ci ENGINE = InnoDB');
